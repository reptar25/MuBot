...
public abstract class EmojiHelper {
	...
	public static final ReactionEmoji.Unicode A_UNICODE = ReactionEmoji.unicode("ðŸ‡¦");
	public static final ReactionEmoji.Unicode B_UNICODE = ReactionEmoji.unicode("ðŸ‡§");
	public static final ReactionEmoji.Unicode C_UNICODE = ReactionEmoji.unicode("ðŸ‡¨");
	public static final ReactionEmoji.Unicode D_UNICODE = ReactionEmoji.unicode("ðŸ‡©");
	public static final ReactionEmoji.Unicode E_UNICODE = ReactionEmoji.unicode("ðŸ‡ª");
	public static final ReactionEmoji.Unicode F_UNICODE = ReactionEmoji.unicode("ðŸ‡«");
	public static final ReactionEmoji.Unicode G_UNICODE = ReactionEmoji.unicode("ðŸ‡¬");
	public static final ReactionEmoji.Unicode H_UNICODE = ReactionEmoji.unicode("ðŸ‡­");
	public static final ReactionEmoji.Unicode I_UNICODE = ReactionEmoji.unicode("ðŸ‡®");
	public static final ReactionEmoji.Unicode J_UNICODE = ReactionEmoji.unicode("ðŸ‡¯");

	public static final ReactionEmoji.Unicode ZERO_UNICODE = ReactionEmoji.unicode("0ï¸?âƒ£");
	public static final ReactionEmoji.Unicode ONE_UNICODE = ReactionEmoji.unicode("1ï¸?âƒ£");
	public static final ReactionEmoji.Unicode TWO_UNICODE = ReactionEmoji.unicode("2ï¸?âƒ£");
	public static final ReactionEmoji.Unicode THREE_UNICODE = ReactionEmoji.unicode("3ï¸?âƒ£");
	public static final ReactionEmoji.Unicode FOUR_UNICODE = ReactionEmoji.unicode("4ï¸?âƒ£");
	public static final ReactionEmoji.Unicode FIVE_UNICODE = ReactionEmoji.unicode("5ï¸?âƒ£");
	public static final ReactionEmoji.Unicode SIX_UNICODE = ReactionEmoji.unicode("6ï¸?âƒ£");
	public static final ReactionEmoji.Unicode SEVEN_UNICODE = ReactionEmoji.unicode("7ï¸?âƒ£");
	public static final ReactionEmoji.Unicode EIGHT_UNICODE = ReactionEmoji.unicode("8ï¸?âƒ£");
	public static final ReactionEmoji.Unicode NINE_UNICODE = ReactionEmoji.unicode("9ï¸?âƒ£");
	public static final ReactionEmoji.Unicode RED_X_UNICODE = ReactionEmoji.unicode("â?Œ");
	...
	public static final ReactionEmoji.Unicode LEFT_ARROW = ReactionEmoji.unicode("â—€ï¸?");
	public static final ReactionEmoji.Unicode RIGHT_ARROW = ReactionEmoji.unicode("â–¶ï¸?");
