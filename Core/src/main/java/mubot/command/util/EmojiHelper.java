...
public abstract class EmojiHelper {
    ...
    public static Unicode numToUnicode(int num) {
        return UNICODE_NUM_MAP.get(num);
    }

    public static int unicodeToNum(Unicode unicode) {
    ...
    public static String numToEmoji(String num) {
    ...
    public static ReactionEmoji.Unicode getUnicodeFromNum(int num) {
    ...
    public static String getPlainLetterFromNum(int num) {
        switch (num) {
            case 0:
                return A_PLAIN;
            case 1:
