...
public final class TrackScheduler extends AudioEventAdapter {
     ...
     * @return String result of queuing the song
     */
    public String queue(AudioTrack track) {
        ...
        if (!player.startTrack(track, true)) {
            ...
            return EmojiHelper.CHECK_MARK + " " + CommandUtil.trackInfo(track) + " was added to the queue ("
                    + EmojiHelper.numToEmoji(getQueue().size()) + ") " + EmojiHelper.CHECK_MARK;
        }
        return EmojiHelper.NOTES + " Now playing " + CommandUtil.trackInfo(track) + " " + EmojiHelper.NOTES;
    }
     ...
     *
     * @param elementNumber the number of track to skip
     */
    public String skipQueue(int elementNumber) {
        ...
        String ret = CommandUtil.trackInfo(Objects.requireNonNull(queue.peek()));
        nextTrack();
        return ret;
    }
    ...
    public AudioTrack removeFromQueue(int index) {
        ...
        queue = new LinkedBlockingQueue<>(listQueue);
    ...
    public void shuffleQueue() {
        ...
        // convert the list back into a queue
        queue = new LinkedBlockingQueue<>(ret);
    }
    ...
    public void seek(int positionInSeconds) {
        if (player != null) {
            ...
            if (currentTrack != null && currentTrack.isSeekable()) {
